...
with open(f"{path_to_tgt}/rx-glp1-dpp4-rxn_output.json",'r') as json_file:
...
df_merge.to_csv(f"{path_to_tgt}/rx-glp1-dpp4_rxcui-ndc.csv",index = False)
